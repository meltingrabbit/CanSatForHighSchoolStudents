...
void loop() {
    ...
    XBEE_Println(pressure);      // 足した！！！
    Serial.println(pressure);
    XBEE_Println(pressure);      // 足した！！！
    Serial.println(humidity);
    XBEE_Println(humidity);      // 足した！！！
    Serial.println(temperature);
		XBEE_Println(temperature);			// 足した！！！
