  ...
  if(line != ""){
    ...
    if (list[0] == "$GPGGA") {
      ...
      if(list[6] != "0") {
        ...
        gps1.lat = GPS_NMEA2DDf_(list[2].toFloat());
        ...
        gps1.lng = GPS_NMEA2DDf_(list[4].toFloat());
        ...
        gps1.height = list[9].toFloat();

        gps1.last_received_time = millis() / 1000;
        Serial.print(F("測位成功"));
...
void GPS_Print() {
  ...
  Serial.print(gps1.last_received_time);
  Serial.println(F(""));
}
